# Generated by Django 3.2 on 2024-01-16 15:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avator', models.ImageField(blank=True, upload_to='categories', verbose_name='avator')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=50, verbose_name='title')),
                ('avator', models.ImageField(blank=True, upload_to='products/', verbose_name='avator')),
                ('is_enable', models.BooleanField(default=True, verbose_name='is enable')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='created time')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='updated time')),
